...
@section('content')
	<div class="container">
		<h2 class="text-center mb-4">Edit a wonderful recipe</h2>
			...
			<div class="col-md-8">
				<form action="{{ route('recipes.update', $recipe) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="row justify-content-center flex-column align-items-center mb-4">
						...
						<img src="/storage/{{ $recipe->image }}" alt="" style="width: 100px">
					</div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="ingredient" type="hidden"
                            name="ingredient"
                            value="{{ old('ingredient', $recipe->ingredient) }}"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input id="preparation" type="hidden"
                            name="preparation"
                            value="{{ old('preparation' , $recipe->preparation) }}"
                        >
